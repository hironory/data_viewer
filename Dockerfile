...
RUN apt-get install build-essential curl git m4 ruby texinfo libbz2-dev libcurl4-openssl-dev libexpat-dev libncurses-dev zlib1g-dev -y
...
# ユーザーを作成
ARG DOCKER_UID=1000
ARG DOCKER_USER=hiro
ARG DOCKER_PASSWORD=hiro
...
#RUN export LD_LIBRARY_PATH="$HOME/.linuxbrew/lib:$LD_LIBRARY_PATH"
